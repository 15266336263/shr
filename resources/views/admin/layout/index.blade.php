...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/d/css/page.css" media="screen">
  <title>@yield('title',Config::get('app.title'))</title></head>
...
<body>
  ...
  <div id="mws-header" class="clearfix">
    ...
    <div id="mws-logo-container">
      ...
      <div id="mws-logo-wrap">
        <img src="/d/images/mws-logo.png" alt="mws admin"></div>
    </div>
    ...
    <div id="mws-user-tools" class="clearfix">
      ...
      <div id="mws-user-info" class="mws-inset">
        ...
        <div id="mws-user-photo">
          <img src="/d/example/profile.jpg" alt="User Photo"></div>
        <!-- Username and Functions -->
        <div id="mws-user-functions">
          <div id="mws-username">这里显示用户名</div>
          <ul>
            <li>
              <a href="/d/#">个人信息</a></li>
            <li>
  ...
  <div id="mws-wrapper">
    ...
    <div id="mws-sidebar">
      ...
      <div id="mws-navigation">
        <ul>
          <li class="active">
            <a href="/d/#">
              <i class="icon-list"></i>友情链接</a>
            <ul>
              <li>
                <a href="/admin/links">友情链接列表</a></li>
              <li>
                <a href="/admin/links/create">友情链接添加</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div id="mws-container" class="clearfix">
      ...
      <div id="mws-footer">Copyright Your Website 2012. All Rights Reserved.</div></div>
  ...
  <!-- Demo Scripts (remove if not needed) --></body>
