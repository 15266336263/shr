    ...
    <div id="mws-sidebar">
      ...
      <div id="mws-navigation">
        <ul>
          <li class="active">
            ...
            <ul>
              <li>
                <a href="/admin/notice">公告列表</a></li>
              <li>
                <a href="/admin/notice/create">公告添加</a></li>
            </ul>
          </li>
        </ul>
      </div>      
      <div id="mws-navigation">
        <ul>
          <li class="active">
            <a href="/d/#">
              <i class="icon-list"></i>文章管理</a>
            <ul>
              <li>
                <a href="/admin/notice">文章列表</a></li>
              <li>
                <a href="/admin/notice/create">文章添加</a></li>
            </ul>
          </li>
        </ul>
      </div>
